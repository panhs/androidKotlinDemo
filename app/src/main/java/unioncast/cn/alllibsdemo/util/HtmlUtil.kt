package unioncast.cn.alllibsdemo.util
...
object HtmlUtil {
     ...
     * @return string
     */
    private fun createHtmlData(showTitle:Boolean,html: String, css: String, js: String): String {
        return if(showTitle)  css +   html + js else
            css + HIDE_HEADER_STYLE + html + js
    }
     ...
     * @return String
     */
    fun createHtmlData(showTitle:Boolean,cssArray: Array<String>?,
                       jsArray: Array<String>?,
                       body: String): String {
        val css = HtmlUtil.createCssTag(cssArray)
        val js = HtmlUtil.createJsTag(jsArray)
        return createHtmlData(showTitle,body, css, js)
    }
}